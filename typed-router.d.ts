...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dashboards-cliente-nfs': RouteRecordInfo<'dashboards-cliente-nfs', '/dashboards/cliente-nfs', Record<never, never>, Record<never, never>>,
    'dashboards-cliente-os': RouteRecordInfo<'dashboards-cliente-os', '/dashboards/cliente-os', Record<never, never>, Record<never, never>>,
    'dashboards-dashboard': RouteRecordInfo<'dashboards-dashboard', '/dashboards/dashboard', Record<never, never>, Record<never, never>>,
    'dashboards-ecommerce': RouteRecordInfo<'dashboards-ecommerce', '/dashboards/ecommerce', Record<never, never>, Record<never, never>>,
    'dashboards-faturamento-geral': RouteRecordInfo<'dashboards-faturamento-geral', '/dashboards/faturamento-geral', Record<never, never>, Record<never, never>>,
    'dashboards-nfs-clientes': RouteRecordInfo<'dashboards-nfs-clientes', '/dashboards/nfs-clientes', Record<never, never>, Record<never, never>>,
    'dashboards-nota-fiscal-servico': RouteRecordInfo<'dashboards-nota-fiscal-servico', '/dashboards/nota-fiscal-servico', Record<never, never>, Record<never, never>>,
